...
public class constants {
    ...
    public static final int OBSTACLE_WIDTH = 200;//63;
    public static final int OBSTACLE_HEIGHT = 120;//140;
    ...
    public static final int SPACING = 170;
    ...
    public static final String MAIN_MUSIC_PREFERENCE_KEY = "main_music";
    public static final String SFX_PREFERENCE_KEY = "sfx";
    ...
    public static final int TRIANGLE1_POINT1_X_OFFSET = 18 + 85;
    public static final int TRIANGLE1_POINT2_X_OFFSET = 18 + 85 + 60;
    public static final int TRIANGLE1_POINT3_X_OFFSET = 18 + 85 + 40;
    public static final int TRIANGLE1_POINT1_Y_OFFSET = 100;
    public static final int TRIANGLE1_POINT2_Y_OFFSET = TRIANGLE1_POINT1_Y_OFFSET;
    public static final int TRIANGLE1_POINT3_Y_OFFSET = TRIANGLE1_POINT1_Y_OFFSET;

    public static final int TRIANGLE2_POINT1_X_OFFSET = 18 + 85 + 60;
    public static final int TRIANGLE2_POINT2_X_OFFSET = 18 + 85 + 60 + 35;
    public static final int TRIANGLE2_POINT3_X_OFFSET = TRIANGLE2_POINT1_X_OFFSET;
    public static final int TRIANGLE2_POINT_Y_OFFSET = 100;
